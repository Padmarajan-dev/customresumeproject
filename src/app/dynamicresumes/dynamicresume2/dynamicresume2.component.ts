...
@Component({
  selector: 'app-dynamicresume2',
  templateUrl: './dynamicresume2.component.html',
  styleUrls: ['./dynamicresume2.component.scss']
})
export class Dynamicresume2Component implements OnInit {
...
getresumecontent()
{
 ...
 resumedetails.append('resumeid',this.thisroute.snapshot.paramMap.get('dynamicresumeid'));
  ...
  this.resumeconetntservice.getresumedetails(resumedetails).subscribe((data)=>{
    ...
    this.photo=`url(${this.userprofile})`;
  });
}
getaboutuscontent()
{
